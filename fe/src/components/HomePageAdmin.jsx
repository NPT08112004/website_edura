    ...
    <div className="home-page">
      ...
      <div className="results-summary">
        <span className="results-count">
          {documents.length > 0 
            ? `Hiển thị ${(currentPage - 1) * itemsPerPage + 1}-${(currentPage - 1) * itemsPerPage + documents.length} trong tổng ${(totalDocuments || documents.length).toLocaleString('vi-VN')} kết quả`
            : 'Không có kết quả'}
